...
HXLINE(  62)			{
HXLINE(  62)				 ::Dynamic key2 = keys1;
HXDLIN(  62)				while(( (bool)(key2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  62)					::String key3 = ( (::String)(key2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE(  64)					if (::StringTools_obj::startsWith(key3,prefix)) {
HXLINE(  66)						this->removeFont(key3);
            					}
            				}
            			}
HXLINE(  70)			 ::Dynamic keys2 = this->sound->keys();
HXLINE(  72)			{
HXLINE(  72)				 ::Dynamic key4 = keys2;
HXDLIN(  72)				while(( (bool)(key4->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE(  72)					::String key5 = ( (::String)(key4->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE(  74)					if (::StringTools_obj::startsWith(key5,prefix)) {
HXLINE(  76)						this->removeSound(key5);
            					}
            				}
            			}
            		}
