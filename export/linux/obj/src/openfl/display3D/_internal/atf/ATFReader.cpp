...
HX_DEFINE_STACK_FRAME(_hx_pos_795af901e983f9af_29_new,"openfl.display3D._internal.atf.ATFReader","new",0x684532c2,"openfl.display3D._internal.atf.ATFReader.new","openfl/display3D/_internal/atf/ATFReader.hx",29,0xa7342032)
HX_LOCAL_STACK_FRAME(_hx_pos_795af901e983f9af_75_readHeader,"openfl.display3D._internal.atf.ATFReader","readHeader",0x13aa7b61,"openfl.display3D._internal.atf.ATFReader.readHeader","openfl/display3D/_internal/atf/ATFReader.hx",75,0xa7342032)
HX_LOCAL_STACK_FRAME(_hx_pos_795af901e983f9af_113_readTextures,"openfl.display3D._internal.atf.ATFReader","readTextures",0x5158860c,"openfl.display3D._internal.atf.ATFReader.readTextures","openfl/display3D/_internal/atf/ATFReader.hx",113,0xa7342032)
HX_LOCAL_STACK_FRAME(_hx_pos_795af901e983f9af_145___readUInt24,"openfl.display3D._internal.atf.ATFReader","__readUInt24",0xfb72da30,"openfl.display3D._internal.atf.ATFReader.__readUInt24","openfl/display3D/_internal/atf/ATFReader.hx",145,0xa7342032)
HX_LOCAL_STACK_FRAME(_hx_pos_795af901e983f9af_154___readUInt32,"openfl.display3D._internal.atf.ATFReader","__readUInt32",0xfb72db0d,"openfl.display3D._internal.atf.ATFReader.__readUInt32","openfl/display3D/_internal/atf/ATFReader.hx",154,0xa7342032)
HX_LOCAL_STACK_FRAME(_hx_pos_795af901e983f9af_29_boot,"openfl.display3D._internal.atf.ATFReader","boot",0xcc603790,"openfl.display3D._internal.atf.ATFReader.boot","openfl/display3D/_internal/atf/ATFReader.hx",29,0xa7342032)
namespace openfl{
namespace display3D{
namespace _internal{
namespace atf{
...
void ATFReader_obj::__construct( ::openfl::utils::ByteArrayData data,int byteArrayOffset){
            	HX_GC_STACKFRAME(&_hx_pos_795af901e983f9af_29_new)
...
bool ATFReader_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2940f3fc;
}

bool ATFReader_obj::readHeader(int _hx___width,int _hx___height,bool cubeMap){
            	HX_GC_STACKFRAME(&_hx_pos_795af901e983f9af_75_readHeader)
...
HXLINE(  96)			::lime::utils::Log_obj::warn(HX_("Only ATF block compressed textures without JPEG-XR+LZMA are supported",25,8c,50,6a),hx::SourceInfo(HX_("openfl/display3D/_internal/atf/ATFReader.hx",32,20,34,a7),96,HX_("openfl.display3D._internal.atf.ATFReader",d0,69,48,2f),HX_("readHeader",83,ed,7b,f6)));
            		}
...
void ATFReader_obj::readTextures( ::Dynamic uploadCallback){
            	HX_GC_STACKFRAME(&_hx_pos_795af901e983f9af_113_readTextures)
...
int ATFReader_obj::_hx___readUInt24( ::openfl::utils::ByteArrayData data){
            	HX_STACKFRAME(&_hx_pos_795af901e983f9af_145___readUInt24)
...
int ATFReader_obj::_hx___readUInt32( ::openfl::utils::ByteArrayData data){
            	HX_STACKFRAME(&_hx_pos_795af901e983f9af_154___readUInt32)
...
hx::ObjectPtr< ATFReader_obj > ATFReader_obj::__alloc(hx::Ctx *_hx_ctx, ::openfl::utils::ByteArrayData data,int byteArrayOffset) {
	ATFReader_obj *__this = (ATFReader_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(ATFReader_obj), true, "openfl.display3D._internal.atf.ATFReader"));
...
void ATFReader_obj::__register()
{
	...
	__mClass->mName = HX_("openfl.display3D._internal.atf.ATFReader",d0,69,48,2f);
...
{
{
            	HX_STACKFRAME(&_hx_pos_795af901e983f9af_29_boot)
