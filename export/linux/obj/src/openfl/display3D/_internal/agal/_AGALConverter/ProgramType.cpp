...
::openfl::display3D::_internal::agal::_AGALConverter::ProgramType ProgramType_obj::FRAGMENT;

::openfl::display3D::_internal::agal::_AGALConverter::ProgramType ProgramType_obj::VERTEX;
...
hx::Static(__mClass) = hx::_hx_RegisterClass(HX_("openfl.display3D._internal.agal._AGALConverter.ProgramType",32,43,0c,ef), hx::TCanCast< ProgramType_obj >,ProgramType_obj_sStaticFields,0,
