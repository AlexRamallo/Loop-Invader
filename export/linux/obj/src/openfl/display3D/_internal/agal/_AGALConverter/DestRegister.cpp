...
HX_DEFINE_STACK_FRAME(_hx_pos_db505e58e1614810_541_new,"openfl.display3D._internal.agal._AGALConverter.DestRegister","new",0x44174203,"openfl.display3D._internal.agal._AGALConverter.DestRegister.new","openfl/display3D/_internal/agal/AGALConverter.hx",541,0xbbd098ff)
HX_LOCAL_STACK_FRAME(_hx_pos_db505e58e1614810_544_getWriteMask,"openfl.display3D._internal.agal._AGALConverter.DestRegister","getWriteMask",0x5a9193f2,"openfl.display3D._internal.agal._AGALConverter.DestRegister.getWriteMask","openfl/display3D/_internal/agal/AGALConverter.hx",544,0xbbd098ff)
HX_LOCAL_STACK_FRAME(_hx_pos_db505e58e1614810_564_toGLSL,"openfl.display3D._internal.agal._AGALConverter.DestRegister","toGLSL",0xceff4f36,"openfl.display3D._internal.agal._AGALConverter.DestRegister.toGLSL","openfl/display3D/_internal/agal/AGALConverter.hx",564,0xbbd098ff)
HX_LOCAL_STACK_FRAME(_hx_pos_db505e58e1614810_554_parse,"openfl.display3D._internal.agal._AGALConverter.DestRegister","parse",0x0e12f096,"openfl.display3D._internal.agal._AGALConverter.DestRegister.parse","openfl/display3D/_internal/agal/AGALConverter.hx",554,0xbbd098ff)
HX_LOCAL_STACK_FRAME(_hx_pos_db505e58e1614810_534_boot,"openfl.display3D._internal.agal._AGALConverter.DestRegister","boot",0x485b812f,"openfl.display3D._internal.agal._AGALConverter.DestRegister.boot","openfl/display3D/_internal/agal/AGALConverter.hx",534,0xbbd098ff)
namespace openfl{
namespace display3D{
namespace _internal{
namespace agal{
...
void DestRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_db505e58e1614810_541_new)
            	}
...
bool DestRegister_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x33588e3f;
}

::String DestRegister_obj::getWriteMask(){
            	HX_STACKFRAME(&_hx_pos_db505e58e1614810_544_getWriteMask)
...
::String DestRegister_obj::toGLSL(hx::Null< bool >  __o_useMask){
            	...
            	HX_STACKFRAME(&_hx_pos_db505e58e1614810_564_toGLSL)
HXLINE( 565)		::String str;
HXLINE( 567)		if ((this->type == 3)) {
HXLINE( 569)			if (hx::IsEq( this->programType,::openfl::display3D::_internal::agal::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
...
HXLINE( 573)			::String str1 = ::openfl::display3D::_internal::agal::AGALConverter_obj::prefixFromType(this->type,this->programType);
...
HX_DEFINE_DYNAMIC_FUNC1(DestRegister_obj,toGLSL,return )
 ...
 ::openfl::display3D::_internal::agal::_AGALConverter::DestRegister DestRegister_obj::parse(int v, ::openfl::display3D::_internal::agal::_AGALConverter::ProgramType programType){
            	HX_GC_STACKFRAME(&_hx_pos_db505e58e1614810_554_parse)
HXLINE( 555)		 ::openfl::display3D::_internal::agal::_AGALConverter::DestRegister dr =  ::openfl::display3D::_internal::agal::_AGALConverter::DestRegister_obj::__alloc( HX_CTX );
...
hx::ObjectPtr< DestRegister_obj > DestRegister_obj::__alloc(hx::Ctx *_hx_ctx) {
	DestRegister_obj *__this = (DestRegister_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(DestRegister_obj), true, "openfl.display3D._internal.agal._AGALConverter.DestRegister"));
...
hx::Val DestRegister_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"programType") ) { programType=inValue.Cast<  ::openfl::display3D::_internal::agal::_AGALConverter::ProgramType >(); return inValue; }
	}
...
static hx::StorageInfo DestRegister_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*  ::openfl::display3D::_internal::agal::_AGALConverter::ProgramType */ ,(int)offsetof(DestRegister_obj,programType),HX_("programType",5e,fb,2c,c4)},
...
void DestRegister_obj::__register()
{
	...
	__mClass->mName = HX_("openfl.display3D._internal.agal._AGALConverter.DestRegister",91,84,2f,80);
...
{
{
            	HX_STACKFRAME(&_hx_pos_db505e58e1614810_534_boot)
