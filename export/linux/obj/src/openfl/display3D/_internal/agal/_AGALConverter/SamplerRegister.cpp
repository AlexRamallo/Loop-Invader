...
HX_DEFINE_STACK_FRAME(_hx_pos_f2f619423b53266e_861_new,"openfl.display3D._internal.agal._AGALConverter.SamplerRegister","new",0x99ae6dd1,"openfl.display3D._internal.agal._AGALConverter.SamplerRegister.new","openfl/display3D/_internal/agal/AGALConverter.hx",861,0xbbd098ff)
HX_LOCAL_STACK_FRAME(_hx_pos_f2f619423b53266e_880_toGLSL,"openfl.display3D._internal.agal._AGALConverter.SamplerRegister","toGLSL",0xc61ef828,"openfl.display3D._internal.agal._AGALConverter.SamplerRegister.toGLSL","openfl/display3D/_internal/agal/AGALConverter.hx",880,0xbbd098ff)
HX_LOCAL_STACK_FRAME(_hx_pos_f2f619423b53266e_886_toSamplerState,"openfl.display3D._internal.agal._AGALConverter.SamplerRegister","toSamplerState",0xf5724833,"openfl.display3D._internal.agal._AGALConverter.SamplerRegister.toSamplerState","openfl/display3D/_internal/agal/AGALConverter.hx",886,0xbbd098ff)
HX_LOCAL_STACK_FRAME(_hx_pos_f2f619423b53266e_864_parse,"openfl.display3D._internal.agal._AGALConverter.SamplerRegister","parse",0x58a72be4,"openfl.display3D._internal.agal._AGALConverter.SamplerRegister.parse","openfl/display3D/_internal/agal/AGALConverter.hx",864,0xbbd098ff)
HX_LOCAL_STACK_FRAME(_hx_pos_f2f619423b53266e_848_boot,"openfl.display3D._internal.agal._AGALConverter.SamplerRegister","boot",0xd70aa9a1,"openfl.display3D._internal.agal._AGALConverter.SamplerRegister.boot","openfl/display3D/_internal/agal/AGALConverter.hx",848,0xbbd098ff)
namespace openfl{
namespace display3D{
namespace _internal{
namespace agal{
...
void SamplerRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_f2f619423b53266e_861_new)
            	}
...
bool SamplerRegister_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x595ae871;
}

::String SamplerRegister_obj::toGLSL(){
            	HX_STACKFRAME(&_hx_pos_f2f619423b53266e_880_toGLSL)
HXLINE( 881)		::String str = ::openfl::display3D::_internal::agal::AGALConverter_obj::prefixFromType(this->type,this->programType);
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toGLSL,return )
 ...
 ::openfl::display::_internal::SamplerState SamplerRegister_obj::toSamplerState(){
            	HX_GC_STACKFRAME(&_hx_pos_f2f619423b53266e_886_toSamplerState)
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toSamplerState,return )
 ...
 ::openfl::display3D::_internal::agal::_AGALConverter::SamplerRegister SamplerRegister_obj::parse( cpp::Int64Struct v, ::openfl::display3D::_internal::agal::_AGALConverter::ProgramType programType){
            	HX_GC_STACKFRAME(&_hx_pos_f2f619423b53266e_864_parse)
HXLINE( 865)		 ::openfl::display3D::_internal::agal::_AGALConverter::SamplerRegister sr =  ::openfl::display3D::_internal::agal::_AGALConverter::SamplerRegister_obj::__alloc( HX_CTX );
...
hx::ObjectPtr< SamplerRegister_obj > SamplerRegister_obj::__alloc(hx::Ctx *_hx_ctx) {
	SamplerRegister_obj *__this = (SamplerRegister_obj*)(hx::Ctx::alloc(_hx_ctx, sizeof(SamplerRegister_obj), true, "openfl.display3D._internal.agal._AGALConverter.SamplerRegister"));
...
static hx::StorageInfo SamplerRegister_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*  ::openfl::display3D::_internal::agal::_AGALConverter::ProgramType */ ,(int)offsetof(SamplerRegister_obj,programType),HX_("programType",5e,fb,2c,c4)},
...
void SamplerRegister_obj::__register()
{
	...
	__mClass->mName = HX_("openfl.display3D._internal.agal._AGALConverter.SamplerRegister",5f,31,f5,06);
...
{
{
            	HX_STACKFRAME(&_hx_pos_f2f619423b53266e_848_boot)
